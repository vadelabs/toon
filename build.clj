...
(defn- pom-template
  [version]
  [[:description "Clojure/ClojureScript implementation of TOON v2.0 (Token-Oriented Object Notation) - A compact data format optimized for LLMs, achieving 49% fewer tokens than formatted JSON while maintaining readability and structure"]
